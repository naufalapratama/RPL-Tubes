...
<body>
    ...
    <div class="contact-clean" id="move">
        <form method="post" action="<?= base_url('Admin/tambahbuku') ?>" enctype="multipart/form-data" style="width: 900px;max-width: 900px;margin-top: 40px;">
            <h2 class="text-center">Input Buku</h2>
            <hr class="aboutunderbrown">
            <?= $this->session->flashdata('message'); ?>
            <p>Judul Buku</p>
            <div class="form-group"><input class="form-control" name="judul_buku" id="judul_buku" placeholder="Judul Buku"></div>
            <p>Nama Pengarang</p>
            <div class="form-group"><input class="form-control" name="nama_pengarang" id="nama_pengarang" placeholder="Nama Pengarang"></input></div>
            <p>Penerbit</p>
            <div class="form-group"><input class="form-control" name="penerbit" id="penerbit" placeholder="Penerbit"></input></div>
            <p>Deskripsi</p>
            <div class="form-group"><textarea class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi/Sinopsis Buku" rows="14"></textarea></div>
            <p>Kategori Buku</p>
            ...
            <div class="form-group"><input type="number" max="10000" class="form-control" name="stok" id="stok" placeholder="Stok Buku..."></input></div>
            <p>Photo Buku</p>
            ...
            <div class="form-group text-center"><button class="btn btn-primary hoverbutton" type="submit" value="upload">Add</button></div>
        </form>
    </div>
