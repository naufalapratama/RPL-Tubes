    ...
    <div data-aos="fade-up">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <?php echo form_open('Admin/caribuku') ?>
            ...
            <div class="row">
                ...
                <div class="col-md-8 text-center" style="padding-bottom: 15px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h1 class="text-center" style="background-color: #ffffff;color: rgb(255,255,255);margin-bottom: 0px;"><a class="btn btn-primary text-left" role="button" style="background-color: #e44242;" href="' . base_url('Admin/updatebuku/') . $b->id_buku . '">Update Buku</a></h1>
                        </div>
                    </div>   
                </div>
            </div>
